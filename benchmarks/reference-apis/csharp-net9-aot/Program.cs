...
logger.LogInformation("csharp-net9-aot reference API starting");
...
// All responses use manually-built JSON via StringBuilder + Results.Content
// to avoid needing additional AOT-serializable type registrations.
// ---------------------------------------------------------------------------
